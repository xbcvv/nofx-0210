...
var DataDictionary = map[string]map[string]BilingualFieldDef{
	...
	"TradeMetrics": {
		...
		"PositionSizeUSD": {
			...
			Unit:      "USDT",
			DescZH:    "以美元计价的仓位大小，用于控制开仓规模",
			DescEN:    "Position size in USD, used for controlling opening size",
		},
		"RiskUSD": {
			NameZH:    "风险金额",
			NameEN:    "Risk USD",
			Unit:      "USDT",
			DescZH:    "单次交易的最大风险金额，用于风险控制",
			DescEN:    "Maximum USD risk per trade, used for risk management",
		},
		"Confidence": {
			NameZH:    "置信度",
			NameEN:    "Confidence",
			Unit:      "%",
			DescZH:    "AI决策的置信度，0-100表示信心程度",
			DescEN:    "Confidence level of AI decision, 0-100 indicates confidence degree",
		},
	},
	...
	"PositionMetrics": {
		...
		"StopLoss": {
			...
			NameEN: "Stop Loss",
			Unit:   "USDT",
			DescZH: "设置的止损价格，用于控制风险",
			DescEN: "Set stop loss price for risk control",
		},
		"TakeProfit": {
			NameZH: "止盈价格",
			NameEN: "Take Profit",
			Unit:   "USDT",
			DescZH: "设置的止盈价格，用于锁定利润",
			DescEN: "Set take profit price for locking profits",
		},
		"Action": {
			NameZH: "交易动作",
			NameEN: "Action",
		...
		"Symbol": {
			NameZH: "交易对",
			NameEN: "Symbol",
			DescZH: "交易对符号，如BTCUSDT",
			DescEN: "Trading pair symbol, such as BTCUSDT",
		},
	},
