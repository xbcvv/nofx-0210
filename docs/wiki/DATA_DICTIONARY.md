...
| ✅ | **Change_{tf}** | 周期涨跌幅 | 动态时间窗口的涨跌幅 (如 Change_1d, Change_4h) | 支持任意周期 (1m-1w) |
| ✅ | **EMA{period}** | 指数均线 | 动态周期的 EMA (如 EMA60, EMA120) | Value=点位, Slope=斜率, Spread=乖离 |
| ✅ | **ATR{period}** | 平均真实波幅 | 动态周期的 ATR (如 ATR7, ATR14) | 衡量波动率 |
| ✅ | **PriceChange15m** | 15m涨跌幅 | 过去15分钟的价格变化百分比 | **核心风控字段**，用于判断暴跌 |
